...
| 5+ | **S3 Files vs Mountpoint vs EFS** (cold-cache) | — | AWS S3 Files "1ms 이하" 마케팅 수치 검증. fio 4종 × 3 시스템 cold-only + SageMaker 마운트 호환성 PoC. | 🛠️ PHASE 1 코드 완료, PHASE 2(배포·실행) 대기 |
